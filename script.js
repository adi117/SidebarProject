...
sidebarMenu.forEach((title) => {
  ...
  title.addEventListener("click", function () {
    sidebarMenu.forEach((color) => {
      const sidebarMenuSecondElement = color.querySelector(
        ".sidebar-menu-title"
      );
...
function changeIcon(menuId) {
  ...
  document.getElementById("iconDashboard").src =
    "assets/Sidebar/Menu/Icon/icon-dashboard-default.svg";
  document.getElementById("iconProduct").src =
    "assets/Sidebar/Menu/Icon/icon-product-default.svg";
  document.getElementById("iconOrder").src =
    "assets/Sidebar/Menu/Icon/icon-order-default.svg";
  document.getElementById("iconCustomer").src =
    "assets/Sidebar/Menu/Icon/icon-customer-default.svg";
  document.getElementById("iconShop").src =
    "assets/Sidebar/Menu/Icon/icon-shop-default.svg";
  document.getElementById("iconSales").src =
    "assets/Sidebar/Menu/Icon/icon-sales-default.svg";
  document.getElementById("iconAnalytics").src =
    "assets/Sidebar/Menu/Icon/icon-analytics-default.svg";
  document.getElementById("iconIntegrations").src =
    "assets/Sidebar/Menu/Icon/icon-integrations-default.svg";

  // Change icon for the clicked menu item
  switch (menuId) {
    case "dashboard":
      document.getElementById("iconDashboard").src =
        "assets/Sidebar/Menu/Icon/icon-dashboard-active.svg";
      break;
    case "product":
      document.getElementById("iconProduct").src =
        "assets/Sidebar/Menu/Icon/icon-product-active.svg";
      break;
    case "order":
      document.getElementById("iconOrder").src =
        "assets/Sidebar/Menu/Icon/icon-order-active.svg";
      break;
    case "customer":
      document.getElementById("iconCustomer").src =
        "assets/Sidebar/Menu/Icon/icon-customer-active.svg";
      break;
    case "shop":
      document.getElementById("iconShop").src =
        "assets/Sidebar/Menu/Icon/icon-shop-active.svg";
      break;
    case "sales":
      document.getElementById("iconSales").src =
        "assets/Sidebar/Menu/Icon/icon-sales-active.svg";
      break;
    case "analytics":
      document.getElementById("iconAnalytics").src =
        "assets/Sidebar/Menu/Icon/icon-analytics-active.svg";
      break;
    case "integrations":
      document.getElementById("iconIntegrations").src =
        "assets/Sidebar/Menu/Icon/icon-integrations-active.svg";
      break;
